...
//	by Stefan Gustavson
//
dvec4 permuted(dvec4 x){return mod(((x*34.0)+1.0)*x, 289.0);}
dvec4 taylorInvSqrtd(dvec4 r){return 1.79284291400159 - 0.85373472095314 * r;}
dvec3 faded(dvec3 t) {return t*t*t*(t*(t*6.0-15.0)+10.0);}

vec4 permute(vec4 x){return mod(((x*34.0)+1.0)*x, 289.0);}
vec4 taylorInvSqrt(vec4 r){return 1.79284291400159 - 0.85373472095314 * r;}
vec3 fade(vec3 t) {return t*t*t*(t*(t*6.0-15.0)+10.0);}

double cnoised(dvec3 P){
  ...
  dvec4 ixy = permuted(permuted(ix) + iy);
  dvec4 ixy0 = permuted(ixy + iz0);
  dvec4 ixy1 = permuted(ixy + iz1);
  ...
  dvec4 norm0 = taylorInvSqrtd(dvec4(dot(g000, g000), dot(g010, g010), dot(g100, g100), dot(g110, g110)));
  g000 *= norm0.x;
  g010 *= norm0.y;
  g100 *= norm0.z;
  g110 *= norm0.w;
  dvec4 norm1 = taylorInvSqrtd(dvec4(dot(g001, g001), dot(g011, g011), dot(g101, g101), dot(g111, g111)));
  g001 *= norm1.x;
  g011 *= norm1.y;
  g101 *= norm1.z;
  g111 *= norm1.w;
