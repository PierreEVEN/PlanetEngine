...

{
...

	{
...

		{
			...
			indices[nf * 3 * 2] = i * (nb + 1) + j; 
			indices[nf * 3 * 2 + 1] = (i + 1) * (nb + 1) + j;
			indices[nf * 3 * 2 + 2] = i * (nb + 1) + j + 1;

			indices[nf * 3 * 2 + 4] = (i + 1) * (nb + 1) + j;
			indices[nf * 3 * 2 + 3] = i * (nb + 1) + j + 1;
			indices[nf * 3 * 2 + 5] = (i + 1) * (nb + 1) + j + 1;
			nf++;
